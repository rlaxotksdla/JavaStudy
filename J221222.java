...
//     int sameValueName=9999; //심지어 부모 클래스와 같은 이름의 변수지만 타입이 달라도 괜찮음 
	 
	 J221222_Child newclass=new J221222_Child();
	 newclass.printResult("");
	 System.out.println(newclass.sameValueName); //부모 클래스와 같은 이름의 변수가 있다면 자식클래스의 값이 적용됨
